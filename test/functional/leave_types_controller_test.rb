...
class LeaveTypesControllerTest < ActionController::TestCase
  ...
  test "should create leave_type" do
    assert_difference('LeaveType.count') do
      post :create, leave_type: { color: @leave_type.color, leave_count: @leave_type.leave_count, type: @leave_type.type }
    end
  ...
  test "should update leave_type" do
    put :update, id: @leave_type, leave_type: { color: @leave_type.color, leave_count: @leave_type.leave_count, type: @leave_type.type }
    assert_redirected_to leave_type_path(assigns(:leave_type))
  end
