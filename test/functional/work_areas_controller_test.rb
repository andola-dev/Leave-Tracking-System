...
class WorkAreasControllerTest < ActionController::TestCase
  ...
  test "should create work_area" do
    assert_difference('WorkArea.count') do
      post :create, work_area: { code: @work_area.code, description: @work_area.description, name: @work_area.name }
    end
  ...
  test "should update work_area" do
    put :update, id: @work_area, work_area: { code: @work_area.code, description: @work_area.description, name: @work_area.name }
    assert_redirected_to work_area_path(assigns(:work_area))
  end
